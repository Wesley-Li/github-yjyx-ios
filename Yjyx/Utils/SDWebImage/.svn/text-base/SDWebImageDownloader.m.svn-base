...
- (void)connection:(NSURLConnection *)aConnection didReceiveResponse:(NSURLResponse *)response
{
    ...
    {
        expectedSize = response.expectedContentLength > 0 ? [[NSNumber numberWithLongLong:response.expectedContentLength] integerValue]  : 0;
...
- (void)connection:(NSURLConnection *)aConnection didReceiveData:(NSData *)data
{
    ...
    self.progressive = (&CGImageSourceCreateImageAtIndex == NULL);
