...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%lu successful, %lu skipped, timeElasped %.2f)", total - (unsigned long)_skippedCount, (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
